...
class Login extends CI_Controller {
    ...
    public function __construct() {
        ...
        if ($this->aauth->is_loggedin()){
            redirect('/africanunity/africanunity');
        }    
    }
    ...
    function show_view($view, $data=''){
      ...
      $this->load->view('africanunity/include/header', $data);
      $this->load->view('africanunity/'.$view, $data);
      $this->load->view('africanunity/include/footer', $data);
    }
