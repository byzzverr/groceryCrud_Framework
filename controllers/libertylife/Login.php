...
class Login extends CI_Controller {
    ...
    public function __construct() {
        ...
        if ($this->aauth->is_loggedin()){
            redirect('/libertylife/libertylife');
        }    
    }
    ...
    function show_view($view, $data=''){
      ...
      $this->load->view('libertylife/include/header', $data);
      $this->load->view('libertylife/'.$view, $data);
      $this->load->view('libertylife/include/footer', $data);
    }
