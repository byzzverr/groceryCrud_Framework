...
class Libertylife extends CI_Controller {
    ...
    function index(){
        ...
        $data['page_title'] = 'Welcome to Liberty Life Application';
    ...
    function add_seen_news_event($news_id){
        ...
        redirect('/libertylife/admin/');
    }

    public function logout() {

        $this->aauth->logout();
        redirect("/libertylife/login/index/logout");
    }
