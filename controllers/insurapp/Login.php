...
class Login extends CI_Controller {
    ...
    function show_view($view, $data=''){
      ...
      $this->load->view('insurapp/include/header', $data);
      $this->load->view('insurapp/'.$view, $data);
      $this->load->view('insurapp/include/footer', $data);
    }
