...
class Management extends CI_Controller {
    ...
    $this->app_settings['app_folder']='insurapp/';
 ...
 function fridges(){
        ...
        $crud->add_action('Location History', '', '/insurapp/dashboard/fridge_locations_history');
        $crud->add_action('Daily Temperature', '', '/insurapp/dashboard/daily_monthly_temperature');
