  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        <form action="/insurapp/dashboard/branch_user_stats" method="post">
          Select User: <select name="user_id"  class="selectpicker" data-show-subtext="true" data-live-search="true" onchange="this.form.submit();">
            <?php 
