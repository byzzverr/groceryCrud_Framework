          ...
          <div class="nav-collapse collapse navbar-responsive-collapse">
            <ul class="nav">
              <li class="active"><a href="/insurapp/admin/">Home</a></li>
               ...
               <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                   <li><a href="/insurapp/agency/user_agency_products">Products </a></li>
                </ul>
              </li>  
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                   <li><a href="/insurapp/dashboard/agency_sales">Sales Overview </a></li>
                </ul>
              </li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="/insurapp/financial/your_wallet">Your Wallet</a></li>
                  <li><a href="/insurapp/financial/your_wallet_transactions">Your Last 200 Wallet Transactions</a></li>
                </ul>
              </li>
            </ul>
