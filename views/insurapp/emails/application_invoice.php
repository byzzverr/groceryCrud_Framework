...
<html>
    <head>
        ...
        <title>Insurapp Payment Request</title>
    <style>
    .invoice-box{
		...
		<style type="text/css">
			...
			*/
			body, #backgroundTable{
				/*@editable*/ background-color:#3fa6bf;
			}
    ...
    <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="background:#3fa6bf;">
    	<center>
    		...
    		<tr><td>
	            ...
	            <table border="0" cellpadding="10" cellspacing="0" width="100%" style="background-color:#fff">
	                	<tr>
	                    	<td align="center" valign="top" class="headerContent">
	                        
	                            <tr>
	                                <td valign="middle"  align="center">
	                                    <img src="<?=base_url();?>assets/insurapp/img/insurapp.png" style="width:200px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowtext />
	                                </td>
	                            </tr>
            ...
            <table style="width: 100%;line-height: inherit;text-align: left; background-color:#fff">
            	<tr>
                	<td valign="top">
                    	<div mc:edit="std_preheader_content">
                        	 Payment Request #: <?=$invoice_id?>
                        </div>
                    </td>
             ...
             <table style="width: 100%;line-height: inherit;text-align: left; background-color:#fff">
                        <tr>
                            <td style="padding: 5px;vertical-align: top;padding-bottom: 40px;"><p>
                            ...
                            <td style="padding: 5px;vertical-align: top;text-align: right;padding-bottom: 40px;">
                                ...
                                Branch : <?=$master_company_info['bank_branch']?><br/>
                                Branch Email : <?=$branch_info['email']?><br>
                                <?=$master_company_info['cellphone']?><br>
                                <?=$master_company_info['email']?><br>
			...
			<? }?>
              ...
              <br/>
              <br/>
              <div  id="templateHeader" class="headerContent"></div>
